...
Route::post('/tim-kiem-chitiet-sp',[HomeController::class, 'tim_kiem_chitiet_sp']);
...
Route::get('/update-order-huy-admin/{orderId}',[CheckoutController::class, 'update_order_huy_admin']);
//loc trang thai
...
Route::get('/loc-order-xuly-cus',[CheckoutController::class, 'loc_order_xuly_cus']);
Route::get('/loc-order-dagoi-cus',[CheckoutController::class, 'loc_order_dagoi_cus']);
Route::get('/loc-order-danggiao-cus',[CheckoutController::class, 'loc_order_danggiao_cus']);
Route::get('/loc-order-hoanthanh-cus',[CheckoutController::class, 'loc_order_hoanthanh_cus']);
Route::get('/loc-order-huy-cus',[CheckoutController::class, 'loc_order_huy_cus']);
//
