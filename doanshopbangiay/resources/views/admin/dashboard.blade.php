...
<div class="row" style="background-color: aliceblue">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xs-12" style="margin-left: 50px">
            <p style="font-size: 20px; margin-top: 10px;">Thống kê lượt xem sản phẩm</p>
            @foreach ($list_pro as $list)
            <div style="display: flex; color: rgb(57, 170, 246)">
                <p style="width: 230px">{{ $list->product_name }}: <p style="color: #FF66CC"> {{ $list->product_view }}_</p><p> lượt xem</p></p>
            </div>
            @endforeach
            <div></div>
        </div>
